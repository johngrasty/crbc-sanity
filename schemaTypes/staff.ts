			...
			fields: [
				{
					...
					description: 'Example: "Professional portrait of John Smith". Use AI Assist (✨) to generate. 10 to 125 characters. Describe what is in the photo. Do not start with "image of".',
